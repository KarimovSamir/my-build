...
export function PageHeader({
  ...
  title: string;
  /**
   * Метка рядом с заголовком — badge статуса на карточке заказа. Стоит именно
   * здесь, а не в подписи: в подписи она читалась как ещё одно свойство
   * заказа, а по макету это состояние самого заказа.
   */
  badge?: ReactNode;
