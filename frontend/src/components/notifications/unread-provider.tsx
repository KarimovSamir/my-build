...
export interface Unread {
  /**
   * Сколько непрочитанных. `null` — число неизвестно: запрос за ним не прошёл.
   *
   * Отличать это от нуля обязательно. Ноль означает «читать нечего» и гасит
   * и значок, и кнопку «Прочитать все» — а показать его вместо неизвестности
   * значило бы заблокировать кнопку при живых уведомлениях на экране.
   */
  count: number | null;
