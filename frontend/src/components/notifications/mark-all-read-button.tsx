 ...
 *
 * Неизвестное число (`null`) кнопку не блокирует: «сколько непрочитанных,
 * неизвестно» — не то же самое, что «их нет», а на экране они в этот момент
 * видны. Ответ маршрута всё равно скажет правду.
 */
