...
| **Выбор исполнителя** — предложения компаний с ценой и сроком | **Тот же заказ у исполнителя**: контакты заказчика, своё предложение, сдача работы |
| <img src="docs/screenshots/notifications.png" alt="Уведомления"> | |
| **Уведомления** — события по заказам, непрочитанные сверху | |
